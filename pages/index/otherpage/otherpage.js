// pages/index/otherpage/otherpage.js
var app = getApp();
...
Page({
  ...
  shareInto: function(e) {
    ...
    wx.showActionSheet({
      ...
      success: function(res) {
        ...
        if (res.tapIndex == 0) {
          wx.navigateTo({
            url: '/pages/index/poster/poster?id=' + that.data.useridd
          })
        }
      },
      fail: function(res) {
  ...
  messageInto: function() {
    wx.navigateTo({
      url: '/pages/index/messageBoard/messageBoard?id=' + this.data.useridd
    })
  },
  ...
  onShareAppMessage: function(option) {
    ...
    return {
      title: '百万妈咪',
      path: '/pages/index/otherpage/otherpage?id=' + this.data.useridd
    };
  }
})